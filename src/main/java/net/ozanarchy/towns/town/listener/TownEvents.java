...
public class TownEvents implements Listener {
        ...
        Bukkit.getScheduler().runTaskAsynchronously(plugin, () -> {
            ...
            economy.remove(uuid, cost, success -> {
                ...
                Bukkit.getScheduler().runTaskAsynchronously(plugin, () -> {
                    ...
                    upkeepRepository.increaseUpkeep(townId, upkeepCost);
    ...
    public void removeChunk(Player p){
        ...
        Bukkit.getScheduler().runTaskAsynchronously(plugin, () -> {
            ...
            if(success){
                ...
                upkeepRepository.decreaseUpkeep(townId, config.getDouble("towns.refundedclaimupkeep"));
    ...
    private void unlockChestLock(Block block) {
        OminousChestLockCompat.unlockIfLocked(block, null);
    }
