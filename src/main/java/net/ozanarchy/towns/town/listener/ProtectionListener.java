...
public class ProtectionListener implements Listener {
    ...
    public ProtectionListener(DatabaseHandler db, ChunkHandler chunkCache, PermissionManager permissionManager, RaidConfigManager raidConfig) {
        this.db = db;
     ...
     */
    public ProtectionListener(TownsPlugin plugin, DatabaseHandler db, ChunkHandler chunkCache, PermissionManager permissionManager, RaidConfigManager raidConfig) {
        this(db, chunkCache, permissionManager, raidConfig);
    }
